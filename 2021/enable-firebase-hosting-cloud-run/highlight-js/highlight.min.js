...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `ruby` grammar compiled for Highlight.js 11.3.1 */
...
})();hljs.registerLanguage("json",e)})();/*! `bash` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("bash",e)})();/*! `xml` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `dockerfile` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("markdown",e)})();/*! `sql` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `go` grammar compiled for Highlight.js 11.3.1 */
